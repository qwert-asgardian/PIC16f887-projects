...
void ADC() {
    ...
    sampling = ADRESL | (ADRESH << 8); // 00 = 0*256 ; 01 = 1*256 ; 10 = 2*256 ; 11 = 3*256   (ADRESL = 255 + (00)= 255) (ADRESL = 255 + (10)= 511) 

    CCPR1L = sampling >> 2;
    CCP1CON |= ((sampling << 4)&0x30);
